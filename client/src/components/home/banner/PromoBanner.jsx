    ...
    >
      <div className="bg-white p-5 flex items-center gap-10 h-[140px]">
        ...
        <div className="flex-1 flex justify-center items-center">
          <Button className="rounded-full max-w-[250px] hover:bg-yellow hover:text-dark transition-colors">
            Thêm vào giỏ hàng
          </Button>
        </div>
      </div>
