...
authRouter
  ...
  .post("/verify-account", validate(verifyAccountValidation), verifyAccountController)
  .post("/refresh-token", refreshTokenController)
  .post("/logout", logoutController)

  // Password recovery
  .post("/password/forgot", validate(forgotPasswordValidation), forgetPasswordController)
  .post("/password/verify-otp", validate(verifyOtpValidation), verifyOtpResetController)
  .post("/password/reset", validate(resetPasswordValidation), resetPasswordController)
